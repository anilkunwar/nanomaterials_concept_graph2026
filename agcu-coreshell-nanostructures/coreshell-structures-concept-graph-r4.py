...
CS_PROBLEM_DEFINITIONS: Dict[CSCoreProblem, CSProblemDefinition] = {
    ...
    CSCoreProblem.PLASMON_TUNABILITY: CSProblemDefinition(
        ...
        scientific_description="The plasmon resonance of Cu@Ag is sensitive to core and shell dimensions.",
        root_cause="Core size and shell thickness determine the dielectric environment and electron density.",
        key_concepts=["core_size", "shell_thickness", "plasmonic_property"],
        key_relationships=[("core_size", "INFLUENCES", "plasmonic_property"), ("shell_thickness", "INFLUENCES", "plasmonic_property")],
        solution_directions=["Synthesize monodisperse cores", "Control shell thickness via reaction time", "Use core-shell alloying strategies"],
        relevant_materials=["core_shell_nanoparticle", "cu_core", "ag_shell"],
        relevant_phenomena=[],
        relevant_properties=["plasmonic_property", "morphology"],
        example_queries=["How does shell thickness affect the LSPR of Cu@Ag?", "What is the optimal core size for plasmonic applications?"],
...
class FallbackAnalyzer(LLMQueryAnalyzer):
    PROBLEM_KEYWORDS = {
        ...
        CSCoreProblem.PLASMON_TUNABILITY: {"plasmon", "lspr", "tunability", "core size", "shell thickness"},
